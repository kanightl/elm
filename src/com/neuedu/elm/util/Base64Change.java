...
public class Base64Change {
	public static void main(String[] args) throws Exception {
		//1、获取图片，生成base64字符串；
//		String imgFile = "D:\\用户目录\\下载\\00-软件开发流程.jpg";//待处理的图片
//		String str = GetImageStr(imgFile);
//		String txtFile = "D:\\用户目录\\下载\\00-软件开发流程-base64.txt";
...
//		System.out.println(str);
		...
		//2、根据base64字符串，生成图片；		
		//注意：看base64的数据可能会有data：base64img，  开头，需要截取从 ，索引+1开始的字符串
...
//		generateImage(str,"D:\\用户目录\\下载\\00-软件开发流程-2.jpg");
